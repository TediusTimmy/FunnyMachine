...
function_program:
 ...
 @nsp   SUB sp, two
        ...
        LDI 0
        ST  0, nsp
    ; Function call decider : arguments 10
    ; Constant 0 : 10
 @two   LDI 2
 @sp    LD  0
 @nsp   SUB sp, two
...
auto_4:
 ...
 @nsp   ADD sp, two
        ST  nsp, two
    ; Call 11
    ; Function call decider : return value 11
 @two   LDI 2
 @sp    LD  0
 @nsp   SUB sp, two
        ST  nsp, two
        LDI 0
        ST  0, nsp
    ; Function call decider : arguments 11
    ; Constant 12 : 11
 @two   LDI 2
 @sp    LD  0
 @nsp   SUB sp, two
