...
int main (int argc, char ** argv)
 {
   ...
   programCall.emitStack(TheContext, data);
   ...
   std::cout << " @op1   PICKP 0, 1, 2" << std::endl;
   std::cout << " @op2   PICKN 1, 2, 3" << std::endl;
   std::cout << " @res   ADD 15, 15" << std::endl;
   std::cout << "mul_loop:" << std::endl;
   std::cout << " @loop  LRA mul_loop" << std::endl;
   std::cout << " @cur   PICKO op2, op1, 15" << std::endl;
   std::cout << " @one   ADC 15, 15" << std::endl;
   std::cout << "        SHL op1, one" << std::endl;
   std::cout << "        SHR op2, one" << std::endl;
   std::cout << "        ADD res, cur" << std::endl;
   ...
   std::cout << " @out   LRA shup_loop_out" << std::endl;
   std::cout << " @dnd   PICK 4, 4, 4" << std::endl;
   std::cout << " @dor   PICK 6, 6, 6" << std::endl;
   std::cout << " @cnt   LDI 16 ; bits in word" << std::endl;
   std::cout << "        RETN dnd, out" << std::endl;
   std::cout << "shup_loop:" << std::endl;
   std::cout << " @loop  LRA shup_loop" << std::endl;
   std::cout << " @dnd   ADD dnd, dnd" << std::endl;
   std::cout << " @dor   PICK dor, dor, dor" << std::endl;
   std::cout << " @cnt   DEC cnt" << std::endl;
   std::cout << "        RETZP dnd, loop" << std::endl;
   std::cout << "shup_loop_out:" << std::endl;
   std::cout << " @out   LRA sub_loop_out" << std::endl;
   std::cout << " @dnd   ADD dnd, dnd" << std::endl;
   std::cout << " @dor   PICK dor, dor, dor" << std::endl;
   std::cout << " @cnt   DEC cnt" << std::endl;
   std::cout << " @quo   ADD 15, 15" << std::endl;
   std::cout << " @run   INC 15" << std::endl;
   std::cout << "        RETZ cnt, out" << std::endl;
   std::cout << "sub_loop:" << std::endl;
   std::cout << " @loop  LRA sub_loop" << std::endl;
   std::cout << "        ADD quo, quo" << std::endl;
   std::cout << "        INC 0" << std::endl;
   std::cout << "        ADD run, run" << std::endl;
   std::cout << "        INC 0" << std::endl;
   std::cout << "        PICKN dnd, 0, 1" << std::endl;
   std::cout << "        SUB 0, dor" << std::endl;
   std::cout << " @dnd   ADD dnd, dnd" << std::endl;
   std::cout << " @dor   PICK dor, dor, dor" << std::endl;
   std::cout << " @cnt   DEC cnt" << std::endl;
   std::cout << " @quo   PICKZP 3, 7, 8" << std::endl;
   std::cout << " @run   PICKZP 4, 4, 5" << std::endl;
   std::cout << "        RETC cnt, loop" << std::endl;
   std::cout << "sub_loop_out:" << std::endl;
   std::cout << "        ENDOP run, quo" << std::endl;
