...
int main (int argc, char ** argv)
 {
   ...
   std::cout << " @dnd   PICK 3, 3, 3" << std::endl;
   std::cout << " @dor   PICK 5, 5, 5" << std::endl;
   std::cout << " @bit   ADC 15, 15" << std::endl;
   std::cout << "shup_loop:" << std::endl;
   std::cout << " @loop  LRA shup_loop" << std::endl;
   std::cout << "        ADD dor, dor" << std::endl;
   std::cout << "        ADD bit, bit" << std::endl;
   std::cout << "        SUB dnd, 1" << std::endl;
   std::cout << " @dnd   PICK dnd, dnd, dnd" << std::endl;
   std::cout << " @dor   PICKN 1, dor, 3" << std::endl;
   std::cout << " @bit   PICKN 2, bit, 3" << std::endl;
   std::cout << "        RETZP 3, loop" << std::endl;
   std::cout << " @dnd   PICK dnd, dnd, dnd" << std::endl;
   std::cout << " @dor   PICK dor, dor, dor" << std::endl;
   std::cout << " @quo   ADD 15, 15" << std::endl;
   std::cout << " @bit   PICK bit, bit, bit" << std::endl;
   std::cout << "sub_loop:" << std::endl;
   std::cout << " @loop  LRA sub_loop" << std::endl;
   std::cout << " @one   ADC 15, 15" << std::endl;
   std::cout << "        SUB dnd, dor" << std::endl;
   std::cout << "        ADD quo, bit" << std::endl;
   std::cout << "        PICKZP 1, 1, dnd" << std::endl;
   std::cout << "        SHR dor, one" << std::endl;
   std::cout << "        PICKZP 3, 2, quo" << std::endl;
   std::cout << "        SHR bit, one" << std::endl;
   std::cout << "        RETC 0, loop" << std::endl;
   std::cout << "        ENDOP 3, 1" << std::endl;
