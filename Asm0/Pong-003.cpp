...
void ROM::generateAssembly()
 {
   ...
   int start = getCodeLoc();
                        ...
                        LRA(592);     // A print later will tell you where this needs to jump to.
                        RET(14, 0);
...
*/
   ...
   int busyWait = getCodeLoc();
                        ...
                        LRA(convertLocationImm12(getRelativeLocation(smallLoop)));
                        RET(14, 0);
